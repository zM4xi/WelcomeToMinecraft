...
<!--- CONTENT START --->
		<section class="padding" id="whywe">
			<div class="container">
				<h2 class="section-title">How much power have our servers</h2>
				<div class="section-body">
					...
					<div class="row col-spacing">
						...
						<div class="col-12 col-md-6 col-lg-4">
							<article class="card">
                <img class="card-img-top" src="img/cpu.jpg">
								<div class="card-body">
						...
						<!-- HERE to create a new spec (2)-->
						<div class="col-12 col-md-6 col-lg-4">
							<article class="card">
                <img class="card-img-top" src="img/ram.jpg">
								<div class="card-body">
						...
						<div class="col-12 col-md-6 col-lg-4">
							<article class="card">
                <img class="card-img-top" src="img/ssd.jpg">
								<div class="card-body">
        ...
        <center><h2 class="section-title">Well pretty damn much :D</h2></center>
			</div>
		</section>
