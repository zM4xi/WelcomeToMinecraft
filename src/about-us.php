...
<!--- CONTENT START --->
		<section class="padding" id="whywe">
			<div class="container">
				<h2 class="section-title">Why you should play here</h2>
				<div class="section-body">
					<div class="row col-spacing">
						<div class="col-12 col-md-6 col-lg-4">
							<article class="card">
								<div class="card-body">
									<h4 class="card-title">Community Friendly</h4>
						...
						<div class="col-12 col-md-6 col-lg-4">
							<article class="card">
								<div class="card-body">
									<h4 class="card-title">Innovative Games</h4>
									<p class="card-text">Mauris eu eros in metus elementum porta eget sed ligula. Praesent consequat, ipsum molestie pellentesque venenatis.</p>
								</div>
							</article>
						</div>
		...
		<section class="padding" id="whoarewe">
			<div class="container">
				<h2 class="section-title">Who had the Idea</h2>
				<div class="section-body">
					<div class="row col-spacing">
						<div class="col-12 col-md-6 col-lg-4">
							<article class="card">
								...
								<div class="card-body">
									<h4 class="card-title">zM4xi</h4>
									<div class="card-subtitle mb-2 text-muted">Owner</div>
									<p class="card-text">Mauris eu eros in metus elementum porta eget sed ligula. Praesent consequat, ipsum molestie pellentesque venenatis.</p>
								</div>
							</article>
						</div>
						<div class="col-12 col-md-6 col-lg-4">
							<article class="card">
								...
								<div class="card-body">
									<h4 class="card-title">zM4xi</h4>
									<div class="card-subtitle mb-2 text-muted">Co-Owner</div>
									<p class="card-text">Mauris eu eros in metus elementum porta eget sed ligula. Praesent consequat, ipsum molestie pellentesque venenatis.</p>
								</div>
							</article>
						</div>
						<div class="col-12 col-md-6 col-lg-4">
							...
							<article class="card">
								<div class="card-body">
									<h4 class="card-title">zM4xi</h4>
									<div class="card-subtitle mb-2 text-muted">Admin</div>
									<p class="card-text">Mauris eu eros in metus elementum porta eget sed ligula. Praesent consequat, ipsum molestie pellentesque venenatis.</p>
								</div>
							</article>
						</div>
